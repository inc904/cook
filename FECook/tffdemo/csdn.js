...
;(function () {
  ...
  ;(() => {
    ...
    const IMG_CATEGORYS = {
      热门: [
        887, 886, 883, 882, 881, 880, 879, 878, 877, 876, 874, 875, 872, 873, 859, 832, 833, 834, 827, 828, 829, 830, 831, 817, 818, 819, 820, 821, 805, 806, 807, 808, 809, 810, 811, 812, 813, 814,
        815, 816, 796, 797, 798, 799, 800, 801, 802, 803, 804, 776, 777, 778, 781, 784, 765, 767, 768, 766, 611, 610, 608, 720
      ],
      冒险岛2: [860, 861, 862, 863, 864, 865, 866, 867, 868, 869, 870, 871],
      守望先锋: [835, 836, 837, 838, 839, 840, 841, 842, 843, 844, 845, 846],
      魔兽世界: [721, 722, 723, 724, 725, 726, 727, 728, 729, 730, 731, 732],
      炉石传说: [733, 734, 735, 736, 737, 738, 739, 740, 741, 742, 743, 744],
      风暴英雄: [660, 661, 662, 663, 664, 665, 666, 667, 668, 669, 670, 671],
      暗黑破坏神Ⅲ: [672, 673, 674, 675, 676, 677, 678, 679, 680, 681, 682, 683],
      星际争霸II: [684, 685, 686, 687, 688, 689, 690, 691, 692, 693, 694, 695],
      冷兔: [749, 750, 751, 752, 753, 754, 755, 756, 757, 758, 759, 760],
      阿狸: [521, 114, 523, 524, 525, 526, 527, 528, 529, 530, 531, 532],
      炮炮兵: [540, 534, 535, 536, 537, 538, 539, 533, 541, 542, 543, 544],
      林心如: [437, 438, 440, 439, 441, 443, 447, 444, 445, 446, 442, 448],
      郑爽: [509, 510, 511, 512, 515, 514, 513, 516, 517, 518, 519, 520],
      戚薇: [449, 456, 451, 452, 453, 454, 455, 450, 457, 459, 458, 460],
      佟丽娅: [485, 486, 490, 488, 489, 487, 491, 492, 493, 494, 495, 496],
      Angelababy: [400, 401, 402, 403, 407, 405, 406, 410, 404, 409, 408, 411],
      唐嫣: [473, 474, 475, 482, 480, 478, 479, 477, 476, 481, 483, 484],
      李冰冰: [424, 425, 427, 430, 426, 429, 428, 431, 432, 433, 434, 435],
      高圆圆: [412, 413, 418, 415, 416, 417, 414, 419, 420, 421, 422, 423],
      孙俪: [461, 462, 463, 464, 471, 466, 468, 467, 469, 470, 465, 472],
      姚晨: [497, 498, 499, 506, 502, 501, 503, 504, 505, 507, 500, 508],
      杨幂: [200, 201, 202, 203, 204, 205, 206, 207, 208, 209, 210, 211],
      刘诗诗: [273, 274, 275, 276, 277, 278, 279, 280, 281, 282, 283],
      胡歌: [260, 261, 262, 263, 628, 629, 630, 631, 268, 269, 270, 271],
      邓紫棋: [320, 321, 322, 323, 324, 325, 326, 327, 328, 329, 330, 331],
      赵丽颖: [249, 2481, 250, 251, 252, 253, 254, 255, 256, 257, 258, 259],
      马天宇: [284, 285, 286, 287, 288, 289, 290, 291, 292, 293, 294, 295],
      陈晓: [233, 225, 226, 227, 228, 229, 230, 231, 232, 224, 234, 235],
      陈伟霆: [308, 309, 310, 311, 312, 313, 314, 315, 316, 317, 318, 319],
      柳岩: [236, 2371, 238, 239, 240, 241, 242, 243, 244, 245, 246, 247],
      吴奇隆: [297, 298, 299, 300, 301, 302, 304, 296, 305, 306, 307],
      风景: [
        822, 823, 824, 825, 826, 54, 62, 5, 37, 115, 116, 117, 118, 120, 122, 123, 49, 25, 121, 26, 43, 45, 48, 51, 70, 4, 10, 11, 17, 23, 6, 28, 38, 16, 31, 42, 163, 164, 165, 166, 167, 168, 170,
        171, 172, 174, 175, 177, 178, 179, 180, 181, 182, 184, 185, 186, 69, 57, 13, 67
      ],
      简约: [12, 111, 114, 53, 27, 33, 41, 35, 2, 14, 44, 21, 36, 8, 150, 125, 1, 169, 173, 176, 183, 46, 61, 47, 52, 64, 24, 58, 18, 59, 55, 9, 20],
      小清新: [74, 71, 113, 119, 124, 29, 65, 32, 34, 39, 40, 50, 60, 73, 30, 63, 126, 128, 66, 19, 112, 22, 68, 7, 15, 3, 56]
    }
    const IMG_MAP = {
      1: '原野 全景图片',
      2: '银汉迢迢 全景图片',
    ...
    const BackgroundImageRange = {
      ...
      get recommendBoxDisplayAttributes() {
        return ['--display-recommend-box', this.range.hideRecommendBox ? 'none' : 'block']
      },
      syncHideRecommendBox() {
        document.body.style.setProperty(...this.recommendBoxDisplayAttributes)
      },
      get copyrightDisplayAttributes() {
        return ['--display-copyright', this.range.hideCopyright ? 'none' : 'block']
      },
      syncHideCopyright() {
        document.body.style.setProperty(...this.copyrightDisplayAttributes)
      },
      get catalogueDisplayAttributes() {
        return ['--display-catalogue', this.range.showCatalogue ? 'block' : 'none']
      },
      syncShowCatalogue() {
    ...
    window.$CSDNCleaner = {
      ...
      cleanCopy() {
        try {
          ...
          try {
            if (mdcp) mdcp.signin = mdcp.copyCode
          } catch (err) {}
          // 为所有的未登录复制按钮增加复制事件
      ...
      onLoad() {
        ...
        window.$CSDNCleaner
          .loadRoundSliderResources() // 加载 color picker
          .then(() => {
      ...
      _bindDialogEvents() {
        ...
        if (!dialogWrapper) {
          console.error(`[${window.$CSDNCleaner.NAME}] Internal error. dialog init failed.`)
          return
        }
        dialogWrapper.addEventListener('click', evt => {
          ...
          } else if (evt.target.classList.contains('category')) {
            // 选择背景图片类目
      ...
      loadColorPicker() {
        ...
        window.AColorPicker.from('div.color-picker-container').on('change', (picker, color) => {
